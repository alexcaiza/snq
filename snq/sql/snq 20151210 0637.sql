...
CREATE TABLE `curso` (
  ...
  `estadocurso` varchar(3) DEFAULT NULL,
  PRIMARY KEY (`codigocurso`),
  UNIQUE KEY `uc_curso` (`codigomateria`,`codigoparalelo`,`codigodocente`,`codigoperiodo`) USING BTREE,
  KEY `fk_curso_periodo` (`codigoperiodo`),
  KEY `fk_curso_tipocurso` (`codigotipocurso`),
  KEY `fk_curso_docente` (`codigodocente`),
  KEY `fk_curso_paralelo` (`codigoparalelo`),
  CONSTRAINT `fk_curso_docente` FOREIGN KEY (`codigodocente`) REFERENCES `docente` (`codigodocente`),
  CONSTRAINT `fk_curso_paralelo` FOREIGN KEY (`codigoparalelo`) REFERENCES `paralelo` (`codigoparalelo`),
  CONSTRAINT `fk_curso_periodo` FOREIGN KEY (`codigoperiodo`) REFERENCES `periodo` (`codigoperiodo`),
  CONSTRAINT `fk_curso_tipocurso` FOREIGN KEY (`codigotipocurso`) REFERENCES `tipocurso` (`codigotipocurso`)
...
INSERT INTO `curso` (`codigocurso`,`codigomateria`,`codigoparalelo`,`codigodocente`,`codigoperiodo`,`codigotipocurso`,`estado`,`estadocurso`) VALUES 
 (1,1,1,1,1,1,'1','CUR'),
 (2,1,2,1,1,1,'1','CUR'),
 (3,3,1,1,1,1,'1','CUR');
...
CREATE TABLE `cursoestudiante` (
  ...
  KEY `fk_cursoestudiante_estudiante` (`codigoestudiante`),
  CONSTRAINT `fk_cursoestudiante_estudiante` FOREIGN KEY (`codigoestudiante`) REFERENCES `estudiante` (`codigoestudiante`),
  CONSTRAINT `fk_cursoestudiante_curso` FOREIGN KEY (`codigocurso`) REFERENCES `curso` (`codigocurso`)
...
CREATE TABLE `cursoestudiantenotas` (
  ...
  KEY `fk_cursoestudiantenotas_curso` (`codigocurso`),
  KEY `fk_cursoestudiantenotas_estudiante` (`codigoestudiante`),
  KEY `fk_cursoestudiantenotas_tiponota` (`codigotiponota`),
  KEY `fk_cursoestudiantenotas_tipoparcial` (`codigotipoparcial`),
  CONSTRAINT `fk_cursoestudiantenotas_tipoparcial` FOREIGN KEY (`codigotipoparcial`) REFERENCES `tipoparcial` (`codigotipoparcial`),
  CONSTRAINT `fk_cursoestudiantenotas_curso` FOREIGN KEY (`codigocurso`) REFERENCES `curso` (`codigocurso`),
  CONSTRAINT `fk_cursoestudiantenotas_estudiante` FOREIGN KEY (`codigoestudiante`) REFERENCES `estudiante` (`codigoestudiante`),
  CONSTRAINT `fk_cursoestudiantenotas_tiponota` FOREIGN KEY (`codigotiponota`) REFERENCES `tiponota` (`codigotiponota`)
...
--
-- Definition of table `cursomateria`
--

DROP TABLE IF EXISTS `cursomateria`;
CREATE TABLE `cursomateria` (
  `codigocursomateria` int(11) NOT NULL AUTO_INCREMENT,
  `codigocurso` int(11) NOT NULL,
  `codigomateria` int(11) NOT NULL,
  PRIMARY KEY (`codigocursomateria`),
  UNIQUE KEY `uc_cursomateria` (`codigocurso`,`codigomateria`),
  KEY `fk_cursomateria_curso` (`codigocurso`),
  KEY `fk_cursomateria_materia` (`codigomateria`),
  CONSTRAINT `fk_cursomateria_curso` FOREIGN KEY (`codigocurso`) REFERENCES `curso` (`codigocurso`),
  CONSTRAINT `fk_cursomateria_materia` FOREIGN KEY (`codigomateria`) REFERENCES `materia` (`codigomateria`)
...
INSERT INTO `cursomateria` (`codigocursomateria`,`codigocurso`,`codigomateria`) VALUES 
 (1,1,1),
 (2,1,2),
 (3,1,3),
 (10,1,4),
...
CREATE TABLE `docente` (
  ...
  KEY `fk_docente_usuario` (`codigousuario`),
  CONSTRAINT `fk_docente_usuario` FOREIGN KEY (`codigousuario`) REFERENCES `usuario` (`codigousuario`)
...
INSERT INTO `empleado` (`codigoempleado`,`codigousuario`,`nombres`,`apellidos`,`cedula`,`genero`,`edad`,`email`,`estado`,`direccion`,`telefono`,`celular`,`imagen`,`CEDULACOMODIN`) VALUES 
 (686,316,'Elizabeth','Diaz','1004082507','',20,'ediaz@salesianosibarra.edu.ec','1',NULL,'','',NULL,NULL),
 (687,317,'Nelly','Beltran','1002078952',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (688,318,'Luis','Beltran','1005246861',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (689,319,'Richard','Encalada','1004198774',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (690,320,'Amparo','Carbali','1001663754',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (691,321,'Sonia','Castro','1001705688',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (692,322,'Carolina','Flores','1002271441',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (693,323,'Mireya','Cerpa','1004093397',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (694,324,'Fernanda','Ramos','1003866330',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (695,325,'Marina','Bastidas','1002450946',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (696,326,'Ricardo','Chiriboga','1001294212',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (697,327,'Telmo','Estevez','1001404563',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (698,328,'Elena','Maria','1001859840',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (699,329,'Marlene','Gomez','1001532991',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (700,330,'Vinicio','Garcia','1001405040',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (701,331,'Sonia','Guerra','1002072849',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (702,332,'Ronald','Hidrobo','1004766448',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (703,333,'Magaly','Rosero','1002564431',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (704,334,'Marco','Jaramillo','1050411139',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (705,335,'Fabian','Macias','1004572317',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (706,336,'Margarita','Cevallos','1001665155',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (707,337,'Cosme','Mejia','1003412044',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (708,338,'Edgar','Naranjo','1003995550',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (709,339,'Miriam','Munioz','1001712544',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (710,340,'Rosa','Ortega','1001862893',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (711,341,'Jessica','Freire','1004267363',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (712,342,'Juan','Perez','1001358835',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (713,343,'Estefano','Palacios','1001842739','',20,'','1',NULL,'111111111','2222222222',NULL,NULL),
 (714,344,'Marco','Perez','400685160',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (715,345,'Cumanda','Regalado','1102020474',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (716,346,'FranKlin','Valenzuela','1721059150',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (717,347,'Wilson','Pozo','400763298',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (718,348,'Rosario','Quito','1001483161',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (719,349,'Sara','Rosero','401037502',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (720,350,'Janeth','Sandoval','1003977996',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (721,351,'Fany','Rivera','1002302345',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (722,352,'Cristina','Montenegro','1003001375',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (723,353,'Maria','Toasa','1004549307',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (724,354,'Inazio','Arrieta','1722495965',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (725,355,'Washington','Suasti','1005249642',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (726,356,'Hugo','Teran','1001758315',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (727,357,'Zulema','Yepez','1001512480',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (728,358,'Rodrigo','Villota','1004550230',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (729,359,'Jose','Carlos','1752536860',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (730,360,'Anita','Chuquin','1002000642',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (731,361,'Maria','Elena','1002260535',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (732,362,'Lorena','Gudinio','1004550206',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (733,363,'Mirian','Erazo','1004733992',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (734,364,'Angeles','Campoverde','5000629161',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (735,365,'Oscar','Pozo','1004453740',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (736,366,'ep','ep',NULL,NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (737,367,'Nancy','Orbe','1004524052',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (738,368,'Ximena','Gudinio','1003463351',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (739,369,'Lucila','Fernandez','1003965983',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (740,370,'Renan','Guerron','1004549034',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (741,371,'Fernando','Portilla','401605553',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (742,372,'Ernesto','Vaca','1004549273',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (743,373,'Miguel','Anrango','1004563217',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (744,374,'Fernando','Bolanios','1003960042',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (745,375,'Miguel','Chavez','1003999610',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (746,376,'Alicia','Guevara','1003826003',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (747,377,'Carmen','Mendoza','1002673570',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (748,378,'Margarita','Paez','1002311361',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (749,379,'Ximena','Ayala','1003564505',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (750,380,'Maribel','Juma','1722631411',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (751,381,'Marco','Chagna','1004719611',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (752,382,'Marco','Manrique','1004757454',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (753,383,'Anabel','Juma','1722631403',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (754,384,'William','Hurtado','1003071030',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (755,385,'Cindy','Hernandez','1004120224',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (756,386,'Leonel','Ruales','1003391370',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (757,387,'Diana','Galarza','1002869830',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (758,388,'Cecilia','Quinteros','1003500749',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (759,389,'Paul','Teran','1003225297',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (760,390,'Laura','Revelo','1004351027',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (761,391,'Christian','Rosado','1003984083',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (762,392,'Alan','Torres','1004149819',NULL,NULL,NULL,'0',NULL,NULL,NULL,NULL,NULL),
 (763,393,'Mijael','Flores','1004368436',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (764,394,'Daniel','Torres','1003123500',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (765,395,'Diana','Carrillo','1003149299',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (766,396,'Hely','Rueda','1004656201',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (767,397,'Cristian','Caranqui','1004694566',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (768,398,'Carmen','Revelo','1709536260',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (769,399,'Juan','Proano','1002543013',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (770,400,'Bladimir','Navarrete','1003190970',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (771,401,'Alvaro','Viteri','1003400395',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (772,402,'Viviana','Puga','1004433486',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (773,403,'Alejandra','Gonzales','1003498860',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (774,404,'Anita','Rojas','104402599',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (775,405,'Laura','Medrano','1001907623',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (776,406,'Angel','Suqui','1900443969',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (777,407,'Cristian','Gaibor','201495769',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (778,408,'Juan','Carlos','1002001574',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (779,409,'Orlando','Sarauz','1002341871',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (780,410,'Gabriela','Vasquez','1003267844',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (781,411,'Francisco','Farinango','1715955967',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (782,412,'Jenny','Navarrete','1003725114',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (783,413,'Franklin','Chavez','1002996443',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL),
 (791,420,'Aldair','Robles','1004696470','M',20,'arobles@gmail.com','1',NULL,'062612013','0990441213','1004696470.jpg',NULL),
 (792,414,'Alex','Salazar','1002556437','M',30,'asalazar@gmail.com','1',NULL,'6212013','0991505871','1002556437.jpg',NULL),
 (794,424,'Maria','Salazar','1002223335','F',20,'msalazar@gmail.com','1',NULL,'062612013','0991505871','1002223335.',NULL),
 (795,425,'Susana','Montenegro','1003001383','F',31,'smontenegro@gmail.com','1',NULL,'2612013','0993441212','1003001383.',NULL),
 (799,426,'Jose','Salazar','1001001005','M',30,'jsalazar@gmail.com','1',NULL,'062612013','0991505871','1001001005.',NULL);
...
INSERT INTO `materia` (`codigomateria`,`nombre`,`descripcion`,`codigoreferencia`,`estado`) VALUES 
 ...
 (2,'Geometria analitica','Geometria','GEA','1'),
 (3,'Informatica','select * from curso;','INF','1'),
 (4,'Computacion','Computacion','COM','1'),
 (5,'Geometria plana','Geometria plana','GEP','1');
...
CREATE TABLE `notaparcial` (
  ...
  KEY `fk_notaparcial_estudiante` (`codigoestudiante`),
  KEY `fk_notaparcial_tipoparcial` (`codigotipoparcial`),
  CONSTRAINT `fk_notaparcial_tipoparcial` FOREIGN KEY (`codigotipoparcial`) REFERENCES `tipoparcial` (`codigotipoparcial`),
  CONSTRAINT `fk_notaparcial_curso` FOREIGN KEY (`codigocurso`) REFERENCES `curso` (`codigocurso`),
  CONSTRAINT `fk_notaparcial_estudiante` FOREIGN KEY (`codigoestudiante`) REFERENCES `estudiante` (`codigoestudiante`)
...
CREATE TABLE `parcialtipoparcial` (
  ...
  KEY `fk_parcialtipoparcial_tipoparcial` (`codigotipoparcial`),
  CONSTRAINT `fk_parcialtipoparcial_tipoparcial` FOREIGN KEY (`codigotipoparcial`) REFERENCES `tipoparcial` (`codigotipoparcial`),
  CONSTRAINT `fk_parcialtipoparcial_parcial` FOREIGN KEY (`codigoparcial`) REFERENCES `parcial` (`codigoparcial`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `periodo` (
  ...
  KEY `fk_periodo_dominio` (`codigodominio`),
  CONSTRAINT `fk_periodo_dominio` FOREIGN KEY (`codigodominio`) REFERENCES `dominio` (`codigodominio`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
...
CREATE TABLE `periodotiponota` (
  ...
  KEY `fk_periodotiponota_tiponota` (`codigotiponota`),
  CONSTRAINT `fk_periodotiponota_tiponota` FOREIGN KEY (`codigotiponota`) REFERENCES `tiponota` (`codigotiponota`),
  CONSTRAINT `fk_periodotiponota_periodo` FOREIGN KEY (`codigoperiodo`) REFERENCES `periodo` (`codigoperiodo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tiponota` (
  ...
  KEY `fk_tiponota_tiponota` (`codigotiponotapadre`),
  CONSTRAINT `fk_tiponota_periodo` FOREIGN KEY (`codigoperiodo`) REFERENCES `periodo` (`codigoperiodo`),
  CONSTRAINT `fk_tiponota_dominio` FOREIGN KEY (`codigodominio`) REFERENCES `dominio` (`codigodominio`),
  CONSTRAINT `fk_tiponota_tiponota` FOREIGN KEY (`codigotiponotapadre`) REFERENCES `tiponota` (`codigotiponota`)
...
CREATE TABLE `tiponotaparcial` (
  ...
  KEY `fk_tiponotaparcial_parcial` (`codigoparcial`),
  CONSTRAINT `fk_tiponotaparcial_parcial` FOREIGN KEY (`codigoparcial`) REFERENCES `parcial` (`codigoparcial`),
  CONSTRAINT `fk_tiponotaparcial_tiponota` FOREIGN KEY (`codigotiponota`) REFERENCES `tiponota` (`codigotiponota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
