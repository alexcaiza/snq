Ext.define('LoginAppDemo.view.notas.NotaParcial', {
		extend: 'Ext.grid.Panel',
		alias: 'widget.notaParcial',
		id: 'gridNotasID',
		store: 'NotasStore',
		loadMask: true,
		stateId: 'stateGridNotaParcial',
		autoScroll: true,
		columnLines: true,
		forceFit: true,
		layout: 'fit',
		...
		constructor : function (config) {
			console.log('The method constructor of the NotaParcial');
		...
		*/
		...
		columns: [
			...
			{ 
				text: 'TRABAJO ACADEMICO INDEPENDIENTE (TAREAS)',
				cls: 'gridTitle3',
				width: 100,
				dataIndex: 'tar',	
				menuDisabled: true,
			...
			{ 
				text: 'ACTIVIDADES INDIVIDUALES EN CLASE', 
				cls: 'gridTitle3',
				width: 100,
				dataIndex: 'aci',	
				menuDisabled: true,
			...
			{ 
				text: 'ACTIVIDADES GRUPALES EN CLASE', 
				cls: 'gridTitle3',
				width: 100,
				dataIndex: 'acg',
				menuDisabled: true,
